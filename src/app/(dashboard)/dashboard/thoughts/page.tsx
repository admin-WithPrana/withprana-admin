...
export default function ThoughtOfTheDayTable() {
    ...
    }, [page, status, sortValue.field, sortValue.order])
        ...
        <div className="rounded-[20px]  p-6">
            <div className="flex justify-between items-center">
                <div className="py-4 font-rubik-400 flex md:flex-row flex-col gap-3">
                    <Select
                        value={status} onValueChange={handleChange}
                    >
                    ...
                    >
                        ...
                        <SelectContent>
                            ...
                            <div className="px-2 py-1">
                                <p className="text-sm text-gray-500 px-2 font-rubik-400">Sheduled At</p>
                                <SelectItem value="scheduledAt-asc" className="font-rubik-400 pl-6">
                                    Ascending
                                </SelectItem>
                                <SelectItem value="scheduledAt-desc" className="font-rubik-400 pl-6">
                                    Descending
                                </SelectItem>
                            </div>
